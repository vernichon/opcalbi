...
//recherche de la derniere valeur du débimetre de Lavaziere Refoulement (négative)
            $query="SELECT * FROM `valeurs` WHERE item ='lav.LAVZREF-.VT_R8'ORDER BY id DESC LIMIT 1";
...
// si la somme des valeurs négatives est superieure à la somme des valeurs positives la fleche sera vers le bas
 ...
 $debit_instantane=-($refoulement_RdbN['valeur']+$refoulement_RefN['valeur']+$refoulement_SJN['valeur'])+($refoulement_RdbP['valeur']+$refoulement_RefP['valeur']+$refoulement_SJP['valeur']);
...
<title>Débit instantane</title><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
...
<h1>Débit instantane</h1>




<table style="width: 380px; height: 103px;" border="1">
   <tbody><tr>
     ...
     <td align="center" width="40"><h1><?php echo "$debit_instantane" ?>  </h1></td>

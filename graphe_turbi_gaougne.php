...
if ($typegraphe=="ligne")
{
    ...
    //calcul du pas de l'axe Y

    $pas=($max-$min)/10;
    $y->set_range( $min, $max, $pas);
    //$chart->set_y_label_steps( 4 );
    $chart->set_y_axis( $y );
    //$chart->set_x_axis( $x );
...
<div>
<form name="resize" >
Minimun : <input  id="min" value="<?php print $limitmin;?>">
Maximun : <input  id="max" value="<?php print $limitmax;?>">
<input type="button" value="Redimensionne" onclick='redimensionne();'>
</form>
</div>
<br>
</body>

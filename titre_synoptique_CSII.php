...
//recherche du dernier timestamp du débit de la Gaougne
            ...
            $query="SELECT * FROM `valeurs` WHERE item ='MicroWin.CS01.USER1.STE_EN_COUR_CS2'ORDER BY id DESC LIMIT 1";
...
?>
  ...
  <title>synoptique_CSII </title>
</head>
<body>

<i class="titre_synoptique">Synoptique du site de Caussels II  <?php echo $timestamp?><i>
</body>
</html>
